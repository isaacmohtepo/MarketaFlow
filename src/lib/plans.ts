...
export const PLANS: Record<PlanId, Plan> = {
  ...
  pro: {
    ...
    features: [
      ...
      "Equipo de hasta 5 personas, con cualquier rol",
      "Planificador de tareas con tablero, lista y calendario",
      "Carrusel multi-imagen, plantillas y biblioteca de hashtags",
