...
import { CreditCard, BarChart3, LayoutGrid, KeyRound, ScrollText, UserCog, Building2, Webhook, HeartPulse, Send, FileText, Sliders, Tag } from "lucide-react";
...
const NAV = [
  ...
  },
  {
    ...
    label: "Cupones",
    icon: Tag,
    desc: "Códigos de descuento para checkout",
  },
  {
    slug: "webhooks",
    label: "Webhooks",
